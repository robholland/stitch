(function() {
  ...
  exports.Package = Package = (function() {
    function Package(config) {
      ...
      this.compileDependency = __bind(this.compileDependency, this);      var _ref2, _ref3, _ref4, _ref5;
    ...
    Package.prototype.compileDependencies = function(callback) {
      return async.map(this.dependencies, this.compileDependency, __bind(function(err, dependencySources) {
        if (err) {
          return callback(err);
        } else {
